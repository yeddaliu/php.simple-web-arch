...
$(function() {
    ...
    $("#contactAdd #submit").button();
    $("#contactAdd #cancel").button().click(function() { 
...
<div id="contactAdd" class="embedded-block">
    <fieldset width="100%" class="ui-corner-all">            
    <legend><?php echo $GLOBALS['MOD_LANG']->getMessage('contact.add.legend'); ?></legend>
        ...
        <div class="clear"></div>
        <div class="right">
            <input type="hidden" id="sendAct" name="sendAct" value="add" />
            <button id="submit" name="submit"><?php echo $GLOBALS['MOD_LANG']->getMessage('gl.btn.submit'); ?></button>
            <button id="cancel" name="cancel"><?php echo $GLOBALS['MOD_LANG']->getMessage('gl.btn.back'); ?></button>
        </div>
